...
#define DEVELOP_WBSOCKET_URL        @"ws://120.25.0.102:9995"
#define P_WBSOCKETAPPAREASPANISH    @"ws://120.25.0.102:9995"

#if (APP_DEV_MODE == 0)
    #define SERVICE_CONFIG_URL     DEVELOP_CONFIG_URL
    #define WBSOCKE_CONFIG_URL     DEVELOP_WBSOCKET_URL
#elif  (APP_DEV_MODE == 1)
    #define SERVICE_CONFIG_URL     P_DRAMAAPPAREASPANISH
    #define WBSOCKE_CONFIG_URL     P_WBSOCKETAPPAREASPANISH
#endif
