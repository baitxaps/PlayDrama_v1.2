...
@implementation PVideoThemeData

#pragma mark - Singleton
+ (PVideoThemeData *) sharedInstance
{
    static PVideoThemeData *singleton = nil;
    static dispatch_once_t once = 0;
    dispatch_once(&once, ^{
        singleton = [[PVideoThemeData alloc] init];
    });
...
- (PVideoThemeEntity*) createThemeClassic
{
    PVideoThemeEntity *themeClassic   = [[[PVideoThemeEntity alloc] init] autorelease];
    ...
    // Animation effects
    NSArray *aniClassic         = [NSArray arrayWithObjects:
                                   [NSNumber numberWithInt:kAnimationFireworks],
                                   nil];
...
- (PVideoThemeEntity*) createThemeNostalgia
{
    PVideoThemeEntity *themeNostalgia     = [[[PVideoThemeEntity alloc] init] autorelease];
    ...
    // Animation effects
    NSArray *aniNostalgia           = [NSArray arrayWithObjects:
                                       [NSNumber numberWithInt:kAnimationSnow],
                                       nil];
...
- (PVideoThemeEntity*) createThemeHeartbeat
{
    PVideoThemeEntity *themeHeartbeat     = [[[PVideoThemeEntity alloc] init] autorelease];
    ...
    // Animation effects
    NSArray *aniHeartbeat           = @[[NSNumber numberWithInt:kAnimationHeart]];
...
- (PVideoThemeEntity*) createThemeFashion
{
    PVideoThemeEntity *themeFashion   = [[[PVideoThemeEntity alloc] init] autorelease];
    ...
    // Animation effects
    NSArray *aniFashion           = @[[NSNumber numberWithInt:kAnimationRing]];
...
- (PVideoThemeEntity*) createThemeRomantic
{
    PVideoThemeEntity *themeRomantic= [[[PVideoThemeEntity alloc] init] autorelease];
    ...
    // Animation effects
    NSArray *aniRomantic = [NSArray arrayWithObjects:
                            [NSNumber numberWithInt:kAnimationStar],
                            nil];
...
- (PVideoThemeEntity*) createThemeStarshine
{
    PVideoThemeEntity *themeStarshine     = [[[PVideoThemeEntity alloc] init] autorelease];
...
- (PVideoThemeEntity*) createThemeMood
{
    PVideoThemeEntity *theme  = [[[PVideoThemeEntity alloc] init] autorelease];
    theme.ID            = kThemeMood;
    ...
    // Animation effects
    NSArray *aniActions     = @[[NSNumber numberWithInt:kAnimationTextSparkle]];
    theme.animationActions  = [NSArray arrayWithArray:aniActions];
    
    return theme;
}

#pragma mark - createFilterSky-m
...
- (PVideoThemeEntity *) createThemeSky
{
    PVideoThemeEntity *theme  = [[[PVideoThemeEntity alloc] init] autorelease];
    theme.ID            = kThemeSky;
    ...
    // Animation effects
    NSArray *aniActions     = @[[NSNumber numberWithInt:kAnimationSky],
...
#pragma mark - createFilterRain -M
...
- (PVideoThemeEntity*) createThemeRain
{
    PVideoThemeEntity *theme      = [[[PVideoThemeEntity alloc] init] autorelease];
    theme.ID                = kThemeRain;
    ...
    // Animation effects
    NSArray *aniActions     = @[[NSNumber numberWithInt:kAnimationRain]];
    theme.animationActions  = [NSArray arrayWithArray:aniActions];
...
- (PVideoThemeEntity*) createThemeFlower
{
    PVideoThemeEntity *theme      = [[[PVideoThemeEntity alloc] init] autorelease];
    ...
    theme.keyFrameTimes   = @[[NSNumber numberWithInt:4]];
    
    // Filter
    //  theme.filter = [self createFilterFlower:fromSystemCamera];
    
    // Animation effects
    theme.animationActions =@[[NSNumber numberWithInt:kAnimationFlower],
                              [NSNumber numberWithInt:kAnimationImageArray],
                              [NSNumber numberWithInt:kAnimationVideoFrame]];
...
- (PVideoThemeEntity*) createThemeBirthday
{
    PVideoThemeEntity *theme      = [[[PVideoThemeEntity alloc] init] autorelease];
    ...
    // Animation effects
    NSArray *aniActions = [NSArray arrayWithObjects:
                           [NSNumber numberWithInt:kAnimationTextStar],
                           [NSNumber numberWithInt:kAnimationImage],
                           [NSNumber numberWithInt:kAnimationBirthday],
                           [NSNumber numberWithInt:kAnimationFire], nil];
    theme.animationActions = [NSArray arrayWithArray:aniActions];
...
- (PVideoThemeEntity*) createThemeOldFilm
{
    PVideoThemeEntity *theme      = [[[PVideoThemeEntity alloc] init] autorelease];
    ...
    // Animation effects
    NSArray *aniActions     = [NSArray arrayWithObjects:
                               [NSNumber numberWithInt:kAnimationScrollScreen],
                               [NSNumber numberWithInt:kAnimationTextScroll],
                               [NSNumber numberWithInt:kAnimationBlackWhiteDot],
                               [NSNumber numberWithInt:kAnimationScrollLine],
                               [NSNumber numberWithInt:kAnimationFlashScreen], nil];
    theme.animationActions  = [NSArray arrayWithArray:aniActions];
...
- (PVideoThemeEntity*) createThemeNiceDay
{
    PVideoThemeEntity *theme      = [[[PVideoThemeEntity alloc] init] autorelease];
    ...
    // Animation effects
    NSArray *aniActions     = [NSArray arrayWithObjects:
                               [NSNumber numberWithInt:kAnimationSpotlight],
                               [NSNumber numberWithInt:kAnimationTextGradient],
                               [NSNumber numberWithInt:kAnimationRipple], nil];
    theme.animationActions  = [NSArray arrayWithArray:aniActions];
