...
- (void)setupViews
{
    ...
    //3.
    self.progressView            = [[PProgressView alloc] initWithFrame:CGRectMake(0, 0, UIScreenWidth, BAR_H )];
...
- (UIView *)getMaskView
{
    UIView *maskView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, UIScreenWidth, UIScreenHeight + DELTA_Y)];
...
- (void)vision:(PBJVision *)vision capturedVideo:(NSDictionary *)videoDict error:(NSError *)error
{
    ...
    NSURL    *urlFile   = [videoDict objectForKey:PBJVisionVideoFileURLKey];
    ...
    [_assetLibrary writeVideoAtPathToSavedPhotosAlbum:[NSURL URLWithString:videoPath] completionBlock:^(NSURL *assetURL, NSError *error1) {
        ...
        playCon.filePath = urlFile;
        playCon.movieFilePath = videoPath;
        WS(weakSelf);
        playCon.backBlock = ^{
