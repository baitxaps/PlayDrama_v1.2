...
#pragma mark - BarrageView 发送消息
- (IBAction)sendMSG:(id)sender
{
    [self endEditing:YES];
    NSString *message = [self.barrawTextField.text stringByTrimmingWhitespace:self.barrawTextField.text ];
    [self.barrageView openBarrage];
    if (self.barrageTextBlock) {
        self.barrageTextBlock(message);
        [self.barrageView addMyComment:message];
        self.barrawTextField.text = @"";
    }
}
